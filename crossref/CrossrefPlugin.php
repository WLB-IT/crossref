...
class CrossrefPlugin extends GenericPlugin implements IDoiRegistrationAgency
{
    ...
    public function exportSubmissions(array $submissions, Context $context): array
    {
        ...
        $temporaryFileId = $exportPlugin->exportAsDownload($context, $submissions, $filterName, $xmlErrors);

        // Since only "general errors" are shown, we don't need specific XML-errors.
        $xmlErrors = [];
    ...
    {
        return [Repo::doi()::TYPE_CHAPTER, Repo::doi()::TYPE_PUBLICATION];
    }
}
