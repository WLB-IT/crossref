...
class CrossrefSettings extends \PKP\doi\RegistrationAgencySettings
{
    ...
    protected function _getPreambleText(Context $context): string
    {
        ...
        $publisherSettingsUrl = Application::get()->getDispatcher()->url(
        ...
        if (!$context->getData('publisher')) {
            $notices[] = __('plugins.importexport.crossref.error.publisherNotConfigured', ['publisherSettingsUrl' => $publisherSettingsUrl]);
        }
